...
describe('Server', () => {
    ...
    describe('GET /api/pierretrolle', () => {
        it('should return a 200', (done) => {
            server.inject('/api/pierretrolle', (res) => {
        ...
        describe('when I provide a list of fields', () => {
            it('should return the appropriate fields', (done) => {
                server.inject('/api/pierretrolle?fields=country', (res) => {
    ...
    describe('POST /api/pierretrolle', () => {
        describe('when there is no payload', () => {
            it('should return 400', (done) => {
                server.inject({ method: 'post', url: '/api/pierretrolle'}, (res) => {
        ...
        describe('when there is a payload', () => {
            it('should return 201', (done) => {
                server.inject({ method: 'post', url: '/api/pierretrolle', payload: { country: 'Foobar'}}, (res) => {
